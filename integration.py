...
options = st.sidebar.radio("Go to", ["Home", "Soil Testing", "Crop Recommendation", "Fertilizer Recommendation", "Farmers' Schemes", "Bio-Organic Vermicompost", "Chatbot"])
...
if options == "Home":
    ...
    st.markdown("[RYTHU BANDHU APPLICATION PROCESS WEBSITE](https://rythubandhu.telangana.gov.in/Default_RB1.aspx)", unsafe_allow_html=True)
    ...
    st.subheader("Chatbot - Agricultural Query Assistant")
